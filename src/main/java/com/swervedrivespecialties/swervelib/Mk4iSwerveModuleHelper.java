...
private static DriveControllerFactory<?, Integer> getKrakenDriveFactory(
	Mk4ModuleConfiguration configuration) {
...
/**
* Creates a Mk4i swerve module that uses a Falcon 500 for driving and a NEO for steering. Module
...
/**
* Creates a Mk4i swerve module that uses a NEO for driving and a Falcon 500 for steering. Module
* information is displayed in the specified ShuffleBoard container.
*
* @param container The container to display module information in.
* @param configuration Module configuration parameters to use.
