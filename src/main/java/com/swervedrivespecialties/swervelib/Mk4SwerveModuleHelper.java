...
private static SteerControllerFactory<?, SteerConfiguration<CanCoderAbsoluteConfiguration>>
	...
	return new Falcon500SteerControllerFactoryBuilder()
		.withVoltageCompensation(configuration.getNominalVoltage())
		.withPidConstants(
			configuration.getSteerKP(), configuration.getSteerKI(), configuration.getSteerKD())
		.withMotionMagic(
...
public static SwerveModule createFalcon500(
	...
	return createFalcon500(
		container,
		Mk4ModuleConfiguration.getDefaultSteerFalcon500(),
		gearRatio,
		driveMotorPort,
		driveCanbus,
		steerMotorPort,
...
public static SwerveModule createNeo(
	...
	return createNeo(
		container,
		Mk4ModuleConfiguration.getDefaultSteerNEO(),
		gearRatio,
		driveMotorPort,
		steerMotorPort,
		steerEncoderPort,
