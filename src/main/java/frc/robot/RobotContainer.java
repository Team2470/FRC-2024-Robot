...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    m_sysIDcontroller.a().whileTrue(m_ShooterPivot.sysIdQuasistatic(Direction.kReverse));

    m_sysIDcontroller.y().whileTrue(m_ShooterPivot.sysIdDynamic(Direction.kForward));
    m_sysIDcontroller.x().whileTrue(m_ShooterPivot.sysIdDynamic(Direction.kReverse));
  }
