...
public void incrementStatus(int segment) {
	...
	public void periodic() {
		...
		// SmartDashboard.putNumber("Spinning Up Segment Status",
		// getLEDStatus(LEDStripSegments.SpinningUp.value));
		// SmartDashboard.putNumber("Full Speed Segment Status",
		// getLEDStatus(LEDStripSegments.FullSpeed.value));
		SmartDashboard.putNumber(
			"Shooting Segment Status", getLEDStatus(LEDStripSegments.Shooter.value));
