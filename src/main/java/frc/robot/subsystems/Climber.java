...
/** Creates a new ClimberPivot. */
	...
	public void periodic() {
		...
		SmartDashboard.putBoolean(
			"Climber " + (m_isLeft ? "Left" : "Right") + " Is Extended", isAtExtendLimit());
		SmartDashboard.putBoolean(
			"Climber " + (m_isLeft ? "Left" : "Right") + " Is Retracted", isAtRetractLimit());
		SmartDashboard.putBoolean("Climber " + (m_isLeft ? "Left" : "Right") + " Is Homed", m_homed);
		SmartDashboard.putNumber(
			"Climber " + (m_isLeft ? "Left" : "Right") + " Position", m_motor.getPosition().getValue());
	...
	public void disengageRatchet() {
		m_Servo.setPosition(m_isLeft ? 0.475 : 0.35);
	}
	...
	public Command extendCommand() {
		return new ParallelCommandGroup(
			...
			new SequentialCommandGroup(
				new WaitCommand(0.2), Commands.runEnd(() -> this.setVoltage(4), this::stop, this)));
	}
}