...
public Command forward() {
	return Commands.runEnd(() -> this.feedShooter(), this::stopFeeder, this);
}

public Command reverse() {
	return Commands.runEnd(() -> this.reverseFeeder(), this::stopFeeder, this);
}
...
public Command forward(DoubleSupplier volts) {
	return Commands.runEnd(() -> this.feederForwards(volts.getAsDouble()), this::stopFeeder, this);
}

public Command reverse(DoubleSupplier volts) {
	return Commands.runEnd(() -> this.feederReverse(volts.getAsDouble()), this::stopFeeder, this);
}
}
