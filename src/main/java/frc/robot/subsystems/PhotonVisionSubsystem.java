...
public class PhotonVisionSubsystem extends SubsystemBase {
	...
	AprilTagFieldLayout AprilTagFieldLayout1 =
	...
	private NetworkTable m_photonVision =
		NetworkTableInstance.getDefault().getTable("photonvision").getSubTable("USB_Camera");
	...
	public double getRangeToTarget(PhotonTrackedTarget target) {
		double range = PhotonUtils.calculateDistanceToTargetMeters(
			TARGET_HEIGHT_METERS, CAMERA_PITCH_RADIANS, CAMERA_HEIGHT_METERES,
