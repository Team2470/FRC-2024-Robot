...
public class IntakePivot extends SubsystemBase {
	...
	public IntakePivot() {
		// m_motor = new WPI_TalonFX(Constants.IntakePivotConstants.MotorID,
		// Constants.IntakePivotConstants.MotorCANBus);
		...
		// m_encoder = new CANCoder(Constants.IntakePivotConstants.EncoderID,
		// Constants.IntakePivotConstants.EncoderCANBus);
		m_encoder = new CANCoder(
			Constants.IntakePivotConstants.EncoderID, Constants.IntakePivotConstants.EncoderCANBus);
	...
	public void periodic() {
		...
		// SmartDashboard.putNumber("Intake Pivot Motor Selected Sensor position",
...
*/
	...
	public Command intakeLocation() {
		return new SequentialCommandGroup(
			new InstantCommand(() -> uplimit = 50), openLoopCommand(() -> 6));
	}
